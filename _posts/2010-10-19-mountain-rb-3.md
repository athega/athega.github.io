...
## Keynote: Aaron Patterson (<a href="http://twitter.com/tenderlove"><span style="color: #000000;"><span style="color: #888888;">@tenderlove</span></span></a>) - "Fear Driven Development".

<img src="/assets/legacy/uploads/2010/10/mountain-rb-buddy-system-300x162.png" alt="" width="300" height="162" />
...
Hans tips för att motverka den känslan är att <em>"Läsa, Läsa, Läsa"</em> – varje dag, samt vad han gärna kallar <em>"The Buddy System"</em> eller i en något mer
...
<img title="mountain-rb-fear-exp" src="/assets/legacy/uploads/2010/10/mountain-rb-fear-exp-300x118.png" alt="" width="270" height="106" />
...
## Jonathan Dahl (<a href="http://twitter.com/jondahl"><span style="color: #000000;"><span style="color: #888888;">@jondahl</span></span></a>) - "Programming and minimalism: lessons from Orwell and the Clash".
...
### Jim Remsick (<a href="http://twitter.com/jremsikjr"><span style="color: #888888;">@jremsikjr</span></a>) - "Functionally Equivalent"

<img title="mountain-rb-bugs" src="/assets/legacy/uploads/2010/10/mountain-rb-bugs-150x150.png" alt="" width="150" height="150" />
...
<ul>
	...
	<li>
        Inga buggar<span style="color: #ff0000;">*</span>
...
### CJ Kihlbom (<a href="http://twitter.com/cjkihlbom"><span style="color: #888888;">@cjkihlbom</span></a>) - "Frontend Testing Frontier"
...
### Paul Sadauskas (<a href="http://twitter.com/theamazingrando"><span style="color: #888888;">@theamazingrando</span></a>) - Forms Don't Have to be this Complicated
...
<img class="" title="mountain-rb-nested-forms-are-bad" src="/assets/legacy/uploads/2010/10/mountain-rb-nested-forms-are-bad-300x149.png" alt="" width="300" height="149" />
...
## Blake Mizerany (<a href="http://twitter.com/bmizerany"><span style="color: #888888;"><span style="color: #000000;"><span style="color: #888888;">@bmizerany</span></span></span></a>) - 1000 ways to kill a Buffalo

<img title="Killing Buffalo" src="/assets/legacy/uploads/2010/10/killing_buffalo-300x210.jpg" alt="Killing Buffalo" width="300" height="210" />
...
<img title="mountain-rb-thousands-of-developers" src="/assets/legacy/uploads/2010/10/mountain-rb-thousands-of-developers-300x141.png" alt="" width="240" height="113" />
...
### Neal Enssle (<a href="http://twitter.com/nealenssle"><span style="color: #888888;">@nealenssle</span></a>) - How to be a better developer in 90 days
