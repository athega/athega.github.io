...
![Genkit Go 1.0 with viking Gopher]({{image_url}})
...
![Your Genkit app - Flows - greetingFlow]({{assets_path}}/Your-Genkit-app-Flows-greetingFlow.png)

Och om du skickar `"Peter"` som input JSON till flödet bör du få ett resultat (och trace) likt detta;

![greetingFlow]({{assets_path}}/greetingFlow.png)
...
![action-execution rpgCharacterGeneratorFlow]({{assets_path}}/action-execution-rpgCharacterGeneratorFlow.png)
